  ...
  return (
    <Col 
      className="mr-5 ml-5 mobile-card m-auto skillC p-0" id='skillC' style={{width: 'fit-content'}}>
        <div>
            <div id={props.card.id} title={props.card.name} className=' frontCard'>
              <Card id={props.card.id} title={props.card.name} data-tilt className='gameCard js-tilt skills-card border-0 slide-in-10 p-0 c' style={{background: 'rgba(0,0,0, 0.86)',  borderRadius: '25px'}}>
            ...
            <div id={props.card.id} title={props.card.name} className=' backCard flex-column justify-content-center'>
              <Card id={props.card.id} title={props.card.name} data-tilt className='gameCard js-tilt skills-card border-0 slide-in-10 p-0 c' style={{background: 'rgba(255,255,255, 0.5)', borderRadius: '25px'}}>
                <CardBody className='m-auto p-0' style={{flex: 'none'}} title={props.card.name} id={props.card.id}>
